export default {
  ...
  kotoura2023jcmi43clinicalplusimage: "Hina Kotoura, Kohei Yamamoto, Koki Horikawa, Ryohei Takamoto, Yuta Nonomiya, Yuichiro Iwashita, Kaori Kuriu, Shoya Ishimaru, Soichiro Nakako, Hiroshi Okamura, Masakazu Iwamura, Koichi Kise, Ayumi Shintani. Tree-based machine learning model integrating clinical table data and chest x-ray images to predict prognosis of covid-19 patients. In Proceedings of the 43rd Joint Conference on Medical Informatics (the 24th conference of the Japan Association for Medical Informatics), JAMI, 2023 (to be appeared).",
