export default function Footer() {
  return (
    <footer>
      <div className="p-4 bg-white shadow md:px-6 md:py-8 dark:bg-gray-900 sm:flex sm:items-center sm:justify-between">
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © 2022 Yuichiro Iwashita. All Rights Reserved.
        </span>
