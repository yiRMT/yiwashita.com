    ...
    <>
      ...
      <div className="publications">
        ...
        <li>
            ...
            {' ('}
            <Link href={`https://publication.imlab.jp/cgi-bin/publication_public.cgi?func=show_detail&id=1940&lang=${locale}`}>{t.LINK}</Link>
            {')'}
          </li>
          <li>
            {locale == 'ja' ? (
            ...
            {' ('}
            <Link href={`https://publication.imlab.jp/cgi-bin/publication_public.cgi?func=show_detail&id=1941&lang=${locale}`}>{t.LINK}</Link>
            {')'}
          </li>
          <li>
            {locale == 'ja' ? (
            ...
            {' ('}
            <Link href={`https://publication.imlab.jp/cgi-bin/publication_public.cgi?func=show_detail&id=1942&lang=${locale}`}>{t.LINK}</Link>
            {')'}
          </li>
          <li>
            {locale == 'ja' ? (
              <>
                <b>岩下 雄一郎</b>, 岩田 基, Andrew W. Vargo, 黄瀬 浩一. 英単語学習を長期的に継続するための適応型学習システムの開発. 2023年電子情報通信学会総合大会講演論文集, 電子情報通信学会, 2023. (査読なし)
              </>
            ) : (
              <>
                <b>Yuichiro Iwashita</b>, Motoi Iwata, Andrew W. Vargo, Koichi Kise. Developing an adaptive learning system for long-term English vocabulary learning. In Proceedings of the 2023 IEICE General Conference, IEICE, 2023. (in Japanese, without peer review)
              </>
            )}
            {' ('}
            <Link href={`https://publication.imlab.jp/cgi-bin/publication_public.cgi?func=show_detail&id=1906&lang=${locale}`}>{t.LINK}</Link>
            {')'}
          </li>
        </ul>
      </div>
      ...
      <table>
        <tbody>
          <tr>
            ...
            <td>{t.PRESENT}</td>
            <td>
              <Link href="https://www.omu.ac.jp/info/news/entry-10852.html">{t.MEDxAI}</Link>
            </td>
          </tr>
          <tr>
            <td>2021.09</td>
            ...
            <td>2024.03</td>
            <td>
              <Link href="https://opu-imp.github.io/lecycl/">Learning Cyclotron (LeCycl)</Link>
            </td>
          </tr>
        </tbody>
      </table>
